...
dApp.listen(3008, async () => {
  ...
  await seedLocalDevAccount('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', '0x1D1042d619E3e4dD91e0acc85E186C6764e6951C', '5000000000000000000');

  console.log('Seeding with WBTC...');
  await seedLocalDevAccount('0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', '0xccF4429DB6322D5C611ee964527D42E5d685DD6a', '0x1D1042d619E3e4dD91e0acc85E186C6764e6951C', 5e8);

  console.log('Seeding with USDC...');
  await seedLocalDevAccount('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', '0x39AA39c021dfbaE8faC545936693aC917d5E7563', '0x1D1042d619E3e4dD91e0acc85E186C6764e6951C', 5000e6);
